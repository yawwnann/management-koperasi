  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.25 6.75A2.25 2.25 0 014.5 4.5h15A2.25 2.25 0 0121.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75zm15 1.5a.75.75 0 01.75.75v3a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zM4.5 6a.75.75 0 00-.75.75v10.5c0 .414.336.75.75.75h15a.75.75 0 00.75-.75V6.75a.75.75 0 00-.75-.75h-15z"
        fill="currentColor"
      />
    </svg>
  );
...
export function MoneySend(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12 20.25a8.25 8.25 0 110-16.5 8.25 8.25 0 010 16.5z"
        fill="currentColor"
      />
      <path
        d="M12 7.5a.75.75 0 01.75.75v3.69l2.28 2.28a.75.75 0 11-1.06 1.06l-2.5-2.5a.75.75 0 01-.22-.53V8.25A.75.75 0 0112 7.5z"
        fill="currentColor"
      />
    </svg>
  );
...
export function MoneyReceive(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      ...
      />
      <path
        d="M12 16.5a.75.75 0 01-.75-.75v-3.69l-2.28 2.28a.75.75 0 11-1.06-1.06l2.5-2.5a.75.75 0 01.53-.22h2.25a.75.75 0 01.75.75v3.69a.75.75 0 01-.75.75z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.25 5.75a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0zM12 3.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 9.25c-2.313 0-4.445.526-6.024 1.414C4.42 11.54 3.25 12.866 3.25 14.5v.102c-.001 1.162-.002 2.62 1.277 3.662.629.512 1.51.877 2.7 1.117 1.192.242 2.747.369 4.773.369s3.58-.127 4.774-.369c1.19-.24 2.07-.605 2.7-1.117 1.279-1.042 1.277-2.5 1.276-3.662V14.5c0-1.634-1.17-2.96-2.725-3.836-1.58-.888-3.711-1.414-6.025-1.414zM4.75 14.5c0-.851.622-1.775 1.961-2.528 1.316-.74 3.184-1.222 5.29-1.222 2.104 0 3.972.482 5.288 1.222 1.34.753 1.961 1.677 1.961 2.528 0 1.308-.04 2.044-.724 2.6-.37.302-.99.597-2.05.811-1.057.214-2.502.339-4.476.339-1.974 0-3.42-.125-4.476-.339-1.06-.214-1.68-.509-2.05-.81-.684-.557-.724-1.293-.724-2.601z"
        fill="currentColor"
      />
      <path
        d="M17.25 7.5a3 3 0 100 6 3 3 0 000-6zM15.75 10.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm4.007 7.28L11.25 15.283a.75.75 0 01-1.06 0L7.233 12.326a.75.75 0 111.06-1.06L11.25 14.223l4.693-4.693a.75.75 0 111.06 1.06z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.625 2.25h12.75a.75.75 0 01.75.75v16.5a.75.75 0 01-.75.75H5.625a.75.75 0 01-.75-.75V3a.75.75 0 01.75-.75zm.75 1.5v15h11.25V3.75H6.375z"
        fill="currentColor"
      />
      <path
        d="M9 7.5a.75.75 0 01.75.75v6a.75.75 0 01-1.5 0v-6A.75.75 0 019 7.5zM12 9.75a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5a.75.75 0 01-.75-.75zM9 15.75a.75.75 0 01.75.75.75.75 0 01-.75.75.75.75 0 01-.75-.75.75.75 0 01.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
