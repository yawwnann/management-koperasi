...
function SettingsContent() {
  ...
  const tabs = [
    { key: "profile" as SettingsTab, label: "Profil", icon: <User className="h-4 w-4" /> },
    { key: "security" as SettingsTab, label: "Keamanan", icon: <Shield className="h-4 w-4" /> },
    { key: "sessions" as SettingsTab, label: "Sesi Aktif", icon: <Clock className="h-4 w-4" /> },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-dark dark:text-white">Pengaturan</h1>
