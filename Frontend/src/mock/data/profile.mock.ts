...
export const ADMIN_PROFILE: UserProfile = {
  ...
  role: "ADMIN",
  angkatan: "2020",
  profilePhoto: "https://placehold.co/png/200x200/3b82f6/ffffff?text=AK",
  coverPhoto:
    "https://placehold.co/png/970x260/3b82f6/ffffff?text=Cover+Photo",
...
const PROFILE_MAP: Record<string, UserProfile> = {
  ...
  "user-3": {
    ...
    profilePhoto: "https://placehold.co/png/200x200/f59e0b/ffffff?text=SA",
    coverPhoto:
      "https://placehold.co/png/970x260/f59e0b/ffffff?text=Cover+Photo",
  },
};
